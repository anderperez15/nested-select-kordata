(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('@angular/core'), require('@ng-bootstrap/ng-bootstrap'), require('string-similarity'), require('@angular/common'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('ng-bootstrap-nested-select', ['exports', 'tslib', '@angular/core', '@ng-bootstrap/ng-bootstrap', 'string-similarity', '@angular/common', '@angular/forms'], factory) :
    (global = global || self, factory(global['ng-bootstrap-nested-select'] = {}, global.tslib, global.ng.core, global['@ng-bootstrap/ng-bootstrap'], global['string-similarity'], global.ng.common, global.ng.forms));
}(this, (function (exports, tslib, core, ngBootstrap, stringSimilarity, common, forms) { 'use strict';
    ...
    var NgBootstrapNestedSelectComponent = /** @class */ (function () {
        ...
        Object.defineProperty(NgBootstrapNestedSelectComponent.prototype, "default", {
            ...
            set: function (defautOption) {
                if (typeof defautOption === 'object') {
                    this._selected = tslib.__assign({}, defautOption);
                }
                else {
                    this._selected = {
                        name: defautOption,
        ...
        NgBootstrapNestedSelectComponent.prototype.selectOption = function (event, option, toggle, selectWithOptions) {
            ...
            if (toggle || (option[this.settings.field] && option[this.settings.field].length && !this.settings.selectAll && !selectWithOptions)) {
                ...
                this._selected = tslib.__assign({}, option);
        ...
        NgBootstrapNestedSelectComponent.prototype.setOptions = function (options) {
            ...
            options.forEach(function (opt) {
                if (typeof opt === 'object') { // "options" is an array of objects
                    var objCopy = tslib.__assign({}, opt);
        ...
        NgBootstrapNestedSelectComponent = tslib.__decorate([
            core.Component({
    ...
    var NgBootstrapNestedSelectModule = /** @class */ (function () {
        ...
        NgBootstrapNestedSelectModule = tslib.__decorate([
            core.NgModule({
